...
?>
	...
	?>
		...
		<div class="work_description">
			<table class="invoice_items items">
				<thead>
				<tr>
					<th class="InvQty"><?php echo $this->lang->line('invoice_quantity');?></th>
					<th class="InvWorkDescr"><?php echo $this->lang->line('invoice_work_description');?></th>
					<th class="InvTaxable"><?php echo $this->lang->line('invoice_taxable');?></th>
					<th class="InvAmtItem"><?php echo $this->lang->line('invoice_amount_item');?></th>
					<th>&nbsp;</th>
				</tr>
				</thead>
				<tbody id="item_area">
			...
			?>
				<tr class="item_row" id="item<?php echo $item_count;?>">
					...
					<td nowrap="nowrap"><p><label><span><?php echo $this->lang->line('invoice_amount');?></span><?php echo $currency_symbol;?><input type="text" id="amount" name="items[<?php echo $item_count;?>][amount]" size="8" value="<?php echo $item->amount;?>" onkeyup="recalculate_items();" value="" /></label></p></td>
					<td>
					<?php if ($item_count > 1):?>
		...
		<div class="amount_listing">
			<p><?php echo $this->lang->line('invoice_amount'). " " .$currency_symbol. " ";?> <span id="item_amount">0.00</span></p>
			<?php if ($row->tax1_rate > 0):?>
			<p><?php echo $row->tax1_desc. " " .$currency_symbol. " ";?> (<?php echo $row->tax1_rate;?>%) <span id="item_tax1amount">0.00</span></p>
			<?php endif;?>
			<?php if ($row->tax2_rate > 0):?>
			<p><?php echo $row->tax2_desc. " " .$currency_symbol. " ";?> (<?php echo $row->tax2_rate;?>%) <span id="item_tax2amount">0.00</span></p>
			<?php endif;?>
			<p><?php echo $this->lang->line('invoice_total'). " " .$currency_symbol. " ";?> <span id="item_total_amount">0.00</span></p>
		</div>
