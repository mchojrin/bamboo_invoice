...
<div class="invoiceViewHold">
	...
	<p>
		...
		<?php if ($row->province != '') {if ($row->city != '') {echo ', ';} echo $row->province;}?><br />
		<?php if ($row->country != '') {echo $row->country;}?><br />
		<?php echo auto_link(prep_url($row->website));?><br /><br />
	...
	<table class="invoice_items stripe">
            <tr>
                    ...
                    <th class="InvTotal"><?php echo $this->lang->line('invoice_total');?></th>
            </tr>
            ...
            <tr>
                    ...
                    <td><p><?php echo $currency_symbol . " ". number_format($item->quantity * $item->amount, 2, $this->config->item('currency_decimal'), $this->config->item('currency_thousands'));?></p></td>
            </tr>
            <?php endforeach;?>
            ...
            <tr>
                <td><p></p></td>
                <td><p></p></td>
                <td><p><strong><?php echo $this->lang->line('invoice_total');?></strong></p></td>
	...
	<?php //we don't need <p> </p> tags as auto_typography is adding it
