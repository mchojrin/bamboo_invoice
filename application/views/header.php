...
*/
echo 'BambooInvoice'; // this is like this so that nobody can get it by a search and replace
/**
	...
	My email is info@bambooinvoice.net, please use it.  I don't want to see more poor quality, half-supported forks 
	...
	Derek Allard (http://bambooinvoice.net)
        Cedric Perrot
*/
echo ': '.$page_title;
?></title>
<meta http-equiv="Content-Type" content="text/html;charset=utf-8" />
<meta name="author" content="Cedric Perrot - http://www.bambooinvoice.net" />
...
<meta name="language" content="<?php echo $this->lang->line('settings_short_language');?>" />
<meta name="copyright" content="Copyright (c) <?php echo date("Y");?> bambooinvoice.net" />
...
bi_currency_symbol = new String("<?php if(isset($currency_symbol)) {echo str_replace('&#0128;', '€', (string)$currency_symbol);}
else {echo str_replace('&#0128;', '€', $this->settings_model->get_setting('currency_symbol'));}?>");
	...
	<div id="container">
		...
		<?php if ($this->session->userdata('logged_in') != NULL): ?>
			...
			<?php if (isset($invoiceOptions)): ?>
				...
				<?php if ($row->amount_paid == 0 || $row->amount_paid < $row->total_with_tax): ?>
		...
		<?php if ($this->session->userdata('logged_in') != NULL && isset($status_menu)):?>
