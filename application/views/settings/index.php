			...
			<div class="content">
				...
				<div class="section" id="invoice_settings">
					...
					<p>
						...
						ISO 4217 ie: USD CHF CAD<?php echo $this->validation->currency_type_error; ?>
					</p>
					...
					<p>
						...
						(ie: 5.0) <?php echo $this->validation->tax2_rate_error; ?>
                                        ...
                                        <p>
						<label for="display_zero_tax"><span><?php echo $this->lang->line('settings_display_zero_tax');?></span></label>
						<input style="width: auto;" class="requiredfield" name="display_zero_tax" type="checkbox" id="display_zero_tax" size="20" value="y" <?php
						if ($this->validation->set_checkbox('display_zero_tax', 'y'))
						{
							echo $this->validation->set_checkbox('display_zero_tax', 'y');
						}
						elseif ($this->settings_model->get_setting('display_zero_tax') == 'y')
						{
				...
				<div class="section" id="advanced_settings">
					...
					<p>
						...
						<span class="error"><?php echo $this->lang->line('settings_save_invoices_warning');?></span>
                                        ...
                                        <p>
						<label for="currency_type_accounting"><span><?php echo $this->lang->line('settings_currency_type_accounting');?></span></label>
						<input name="currency_type_accounting" type="text" id="currency_type_accounting" size="20" value="<?php echo ($this->validation->currency_type_accounting) ? ($this->validation->currency_type_accounting) : ($row->currency_type_accounting);?>" />
						<?php echo $this->lang->line('settings_currency_type_accounting2');?><?php echo $this->validation->currency_type_accounting_error; ?>
					</p>
                                        <p>
						<label for=""><span><?php echo $this->lang->line('settings_exchange_surplus_middle_exchange_rate');?></span></label>
						<input name="exchange_surplus_middle_exchange_rate" type="text" id="exchange_surplus_middle_exchange_rate" size="6" value="<?php echo ($this->validation->exchange_surplus_middle_exchange_rate) ? ($this->validation->exchange_surplus_middle_exchange_rate) : ($row->exchange_surplus_middle_exchange_rate);?>" />
						<?php echo $this->lang->line('settings_exchange_surplus_middle_exchange_rate2');?><?php echo $this->validation->exchange_surplus_middle_exchange_rate_error; ?>
					</p>
                                        <p>
						<label for="api_key"><span><?php echo $this->lang->line('settings_api_key');?></span></label>
						<input name="api_key" type="text" id="api_key" size="20" value="<?php echo ($this->validation->api_key) ? ($this->validation->api_key) : ($row->api_key);?>" />
						<?php echo $this->validation->api_key_error; ?>
					</p>					<p>
