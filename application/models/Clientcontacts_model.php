...
class clientcontacts_model extends CI_Model
{
    ...
    function addClientContact($client_id, $first_name, $last_name, $email,
            $phone = '', $title = '', $access_level = 0)
    {
        $contact_info = array(
    ...
    function editClientContact($id, $client_id, $first_name, $last_name, $email,
            $phone = '', $title = '', $access_level = 0)
    {
        $contact_info = array(
            'client_id' => (int) $client_id,
    ...
    function password_change($id, $new_password)
    {
        ...
        $this->db->where('id', $id);
        $this->db->set('password', $this->encryption->encrypt($new_password));
        $this->db->update('clientcontacts');
