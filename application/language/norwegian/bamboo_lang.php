...
$lang['invoice_email_demo'] = 'For å unngå uønsket bruk av denne demoen, eposter blir <em>ikke</em> sent. For å se en kopi av PDF-vedleggt, velg &ldquo;Lag faktura&rdquo; fra menyen.';
...
$lang['utilities_connection_failed'] = "Kunne ikke koble til http://bambooinvoice.net.";
...
$lang['menu_did_you_know_quotes'] = array(
					"BambooINVOICE har forum på forums.bambooinvoice.net for support, ønske om nye funksjoner, og for å chatte.",
					...
					"Denne hjelpe-filen utvikles daglig. Besøk bambooinvoice.net for nye oppdateringer!",
