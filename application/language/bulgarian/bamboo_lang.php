...
$lang['menu_did_you_know_quotes'] = array(
					...
					"BambooINVOICE има форуми на forums.bambooinvoice.net за съпорт, заявяване на разширения, и за чат.",
					...
					"Файлът с информация за помощ се обновява всеки ден. Посети bambooinvoice.net за последната версия!",
