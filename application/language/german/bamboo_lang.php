...
$lang['accounts_admin_account_create_success'] = 'Admin Konto erfolgreich erstellt';

$lang['accounts_admin_account_create_fail'] = 'Problem mit dem Erstellen des Admin Konto';

$lang['accounts_admin_account_delete_success'] = 'Admin Konto wurde erfolgreich gel&ouml;scht';

$lang['accounts_admin_account_delete_fail'] = 'Problem mit dem L&ouml;schen des Admin Konto';
...
$lang['invoice_net_amount'] = 'Zwischensumme (Netto)';
...
$lang['invoice_amount_paid'] = 'Bezahlter Betrag';

$lang['invoice_amount_outstanding'] = 'Ausstehender Betrag';
...
$lang['invoice_comment_success'] = 'Notiz erfolgreich hinzugef&uuml;gt, sie k&ouml;nnen die Notiz.';
...
$lang['invoice_blind_copy_me'] = 'Mir selber eine Blindkopie des Emails zustellen';
...
$lang['invoice_item'] = 'Rechnungsposition';

$lang['invoice_last_used'] = 'letzte benutzte Nummer ';

$lang['invoice_new_item'] = 'Neue Rechnungsposition';
...
$lang['invoice_not_sent'] = 'Die Rechnung wurde noch nicht an den Kunden gesendet. Um diese Rechnung zu verschicken, w&auml;hlen Sie &quot;Rechnung verschicken&quot; im Men&uuml;.';
...
$lang['invoice_tax_exempt'] = 'Hinweis: Dieser Kunde is von der Mehrwertsteuer befreit.'; // I read this as 'is not controllable'

//Suggestion: $lang['invoice_tax_exempt'] = 'Hinweis: Dieser Kunde is von der Mehrwertsteuer befreit.';
...
$lang['invoice_is_tax_exempt'] = 'ist nicht Mehrwertsteuer befreit';  //Same problem as above.

//Suggestion: $lang['invoice_is_tax_exempt'] = 'ist umsatzsteuerbefreit';

$lang['invoice_you'] = 'You';

$lang['invoice_accounting_purpose'] = 'Nur für internen Gebrauch; Buchhaltungsbetrag und Wechselkurs per Rechnungsdatum';

$lang['login_allow_login'] = 'Hinzuf&uuml;gen eines neuen Admin Kontos';
...
$lang['login_password_confirm'] = 'Passwort best&auml;tigen'; // to be translated
...
$lang['menu_duplicate_invoice'] = 'Rechnung duplizieren';
...
$lang['menu_private_note'] = 'Private Notiz';
...
$lang['menu_utilities'] = 'Werkzeuge';



$lang['notice_english_only'] = 'Nur in Englisch verf&uuml;gbar';
...
$lang['reports_no_data'] = 'Keine Informationen f&uuml;r diese Daten verf&uuml;gbar.';

$lang['reports_yearly_income'] = 'J&auml;hrliche Einnahmen';



$lang['settings_account_settings'] = 'Kontoeinstellungen';

$lang['settings_invoice_settings'] = 'Rechnungseinstellungen';

$lang['settings_advanced_settings'] = 'Erweiterte Einstellungen';
...
$lang['settings_exchange_surplus_middle_exchange_rate'] = 'Ende des Tages Wechselkurs +/-';

$lang['settings_api_key'] = 'openexchangerates.org api key';
...
$lang['settings_primary_email_message'] = 'Eine &Auml;nderung an dieser Email Addresse hat zur Folge, dass sie sich mit dieser neuen Email Adresse anmelden m&uuml;ssen.';
...
$lang['settings_display_zero_tax'] = 'Null Mehrwertsteuerzeile anzeigen';

$lang['utilities_download_backup'] = 'Download backup';

$lang['utilities_automatic_version_check'] = 'Automatische Versionspr&uuml;fung'; 

$lang['utilities_phpinfo'] = 'PHP info';

$lang['utilities_invoices_update'] = 'W&auml;hrung auf Rechnung aktualisieren';

$lang['utilities_invoices_update_message'] = 'Rechnungen erfolgreich aktualisiert';

$lang['utilities_phpinfo_not_available'] = 'Diese Funktionlit&auml;t ist in dieser Version nicht verf&uuml;gbar.';

$lang['utilities_new_version_available'] = "Eine neue Version von BambooInvoice ist jetzt erh&auml;ltlich. "; // space after period

$lang['utilities_up_to_date'] = "You are using the most recent version of BambooInvoice.";

$lang['utilities_connection_failed'] = "Eine Verbindung zu http://bambooinvoice.net konnte nicht etabliert werden.";

$lang['utilities_version_check'] = "Pr&uuml;fen f&uuml;r eine neue Version";

$lang['utilities_version_undetermined'] = "Version konnte nicht ermittelt werden.";



$lang['menu_did_you_know_quotes'] = array(

					"BambooINVOICE wird auf Basis der GPL Lizenz ver&ouml;ffentlicht.",

					"Ihre Einstellungen k&ouml;nnen zu jedem Zeitpunkt mit dem &ldquo;Einstellungen&rdquo; Men&uuml; ge&auml;ndert werden.",

					"Die Hilfe-Seiten wachsen jeden Tag. Besuchen Sie bambooinvoice.net, um die aktuellste Version zu erhalten!",
