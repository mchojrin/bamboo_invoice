...
<p><label for="startDate"><?php echo $this->lang->line('reports_start_date');?> <input type="text" id="startDate" size="10" name="startDate" value="<?php echo date("Y-01-01");?>" /></label> 
<label for="endDate"><?php echo $this->lang->line('reports_end_date');?> <input type="text" id="endDate" size="10" name="endDate" value="<?php echo date("Y-12-31");?>" /></label> <input type="submit" value="<?php echo $this->lang->line('reports_generate_report');?>" /></p>
</form>
...
<p><?php echo $this->lang->line('invoice_there_are_currently');?> <?php echo $overdueInvoicesCount;?> <?php echo $this->lang->line('invoice_overdue_invoices');?><?php if ($overdueInvoicesCount > 0):?>.  <?php echo $this->lang->line('invoice_total'). " ";?> <?php echo $this->settings_model->get_setting('currency_type_accounting');?><?php echo number_format($overdueInvoicesAmount, 2, $this->config->item('currency_decimal'), $this->config->item('currency_thousands'));?><?php endif; ?></p>

<h3><?php echo $this->lang->line('invoice_open');?></h3>
<p><?php echo $this->lang->line('invoice_there_are_currently');?> <?php echo $openInvoicesCount;?>. <?php if ($openInvoicesCount > 0):?><?php echo $this->lang->line('invoice_total');?>: <?php echo $this->settings_model->get_setting('currency_type_accounting'). " ";?><?php echo number_format($openInvoicesAmount, 2, $this->config->item('currency_decimal'), $this->config->item('currency_thousands'));?><?php endif; ?></p>
