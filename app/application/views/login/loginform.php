<div id="loginformdiv">
	...
	<?php echo form_open('login', array('id' => 'loginform', 'onsubmit' => 'return checkform();'));?>
		...
		<p>
			...
			<input type="text" name="username" id="username" value="<?php if ($this->settings_model->get_setting('demo_flag') == 'y') {echo 'info@bambooinvoice.net';}?>" maxlength="50" class="loginitem" size="40" /> 
