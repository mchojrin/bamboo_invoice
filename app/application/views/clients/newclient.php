...
<?php echo form_open('clients/newclient', array('id' => 'newClientForm', 'onsubmit' => 'return requiredFields();'));?>
	...
	<p><label><span><?php echo $this->lang->line('settings_currency_type');?>:</span> <input type="text" name="currency_type" id="currency_type" size="20" maxlength="20" value="<?php echo $this->validation->currency_type ?>" /></label> <?php echo $this->validation->currency_type_error; ?></p>
	<p><label><span><?php echo $this->lang->line('settings_currency_symbol');?>:</span> <input type="text" name="currency_symbol" id="currency_symbol" size="9" maxlength="9" value="<?php echo $this->validation->currency_symbol;?>" /></label> <?php echo $this->validation->currency_symbol_error; ?></p>
	<p><label><span><?php echo $this->lang->line('settings_days_payment_due');?>:</span> <input type="text" name="days_payment_due" id="days_payment_due" size="5" maxlength="5" value="<?php echo $this->validation->days_payment_due;?>" /></label> <?php echo $this->validation->days_payment_due_error; ?></p>
        <p><label><span><?php echo $this->lang->line('settings_default_note')."<br/>".$this->lang->line('invoice_note_max_chars');?>:</span> <textarea name="invoice_note_default" id="invoice_note_default" cols="50" rows="5" maxlength="255"><?php echo $this->validation->invoice_note_default;?></textarea></label> <?php echo $this->validation->invoice_note_default_error; ?></p>
