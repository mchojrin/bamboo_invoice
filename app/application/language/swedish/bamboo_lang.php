...
$lang['utilities_connection_failed'] = "Det gick inte att ansluta till http://bambooinvoice.net.";
...
$lang['menu_did_you_know_quotes'] = array(
										...
										'BambooINVOICE har forum på forums.bambooinvoice.net för support, funktionen begäran och chat.',

										'BambooINVOICE är släppt under GPL-licens.',

										'Dina inställningar kan ändras när som helst via menyn Inställningar.',

										'Hjälperfiler förnyas varje dag. Besök bambooinvoice.net för den senaste versionen!',
