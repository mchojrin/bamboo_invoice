...
$lang['accounts_admin_account_create_success'] = 'Account amministrativo creato';

$lang['accounts_admin_account_create_fail'] = 'Problemi nella creazione dell\'account amministrativo';

$lang['accounts_admin_account_delete_success'] = 'Account amministrativo eliminato';

$lang['accounts_admin_account_delete_fail'] = 'Problemi nell\'eliminazione dell\'account amministrativo';
...
$lang['actions_required_fields'] = 'Campo obbligatorio';
...
$lang['clients_cancel_add_contact'] = 'Annulla la creazione';
...
$lang['clients_contact_add'] = 'Impossibile aggiungere questo contatto. Attenzione: sono necessari Nome, Cognome ed un indirizzo email valido.';
...
$lang['clients_delete_all_invoices'] = 'Cancella il cliente e tutte le sue fatture';
...
$lang['clients_new_contact_fail'] = 'Impossibile aggiungere questo contatto. Attenzione: sono necessari Nome, Cognome ed un indirizzo email valido.';
...
$lang['error_date_fill'] = 'Si sono verificati degli errori. La data deve essere nel formato AAAA-MM-GG, e la quanti&agrave; deve essere un numero. Torna indietro e riprova.';

$lang['error_date_format'] = 'La data deve essere nel formato AAAA-MM-GG';

$lang['error_email_recipients'] = 'Scegli almeno un destinatario per questa fattura';
...
$lang['error_problem_editing'] = 'Si &egrave; verificato un errore durante la modifica della fattura. Segnalare l\'errore error invoice_controller_edit';
...
$lang['install_welcome'] = 'Benvenuto in BambooInvoice.  Per poter eseguire l\'installazione ho bisogno di alcuni tuoi dati.';



$lang['invoice_add_note'] = 'Aggiungi annotazione';
...
$lang['invoice_amount_paid'] = 'Importo pagato';

$lang['invoice_amount_outstanding'] = 'Importo rimanente';

$lang['invoice_bill_to'] = 'Spettabile';
...
$lang['invoice_date_issued_full'] = 'Data emissione (nel formato AAAA-MM-GG)';

$lang['invoice_date_paid_full'] = 'Data Scadenza (nel formato AAAA-MM-GG)';
...
$lang['invoice_email_no_recipient'] = 'Attenzione: torna indietro e seleziona il destinatario di questa fattura.';
...
$lang['invoice_history_comments'] = 'Storico fattura &amp; annotazioni';
...
$lang['invoice_not_taxable'] = 'Esentasse';

$lang['invoice_not_unique'] = 'Numero fattura gi&agrave; presente';

$lang['invoice_note'] = 'Annotazioni';
...
$lang['login_allow_login'] = 'Consenti il login a questi utenti';

$lang['login_caps_lock'] = 'Assicurati che il tasto <em>Bloc Maiusc</em> non sia premuto';

$lang['login_forgot_password'] = 'Ho dimenticato la password';
...
$lang['menu_accounts'] = 'Account';

$lang['menu_bugs'] = 'Errori';

$lang['menu_catchphrase'] = 'Fatturazione online<br />Semplice,<br />Bella,<br />Open Source';

$lang['menu_catchphrase_nobreak'] = 'Fatturazione online semplice, bella, Open Source';

$lang['menu_changelog'] = 'Log dei cambiamenti';
...
$lang['menu_duplicate_invoice'] = 'Duplica fattura';
...
$lang['menu_invoice_summary'] = 'Elenco fatture';

$lang['menu_invoice_note'] = 'Annotazioni fattura';
...
$lang['menu_private_note'] = 'Annotazioni';
...
$lang['reports_back_to_reports'] = 'Ritorna ai report';

$lang['reports_collected'] = 'collected';

$lang['reports_end_date'] = 'al (aaaa-mm-gg)';
...
$lang['reports_invoices_issued_year'] = 'fatture emesse quest\'anno';

$lang['reports_legend'] = 'Legenda';

$lang['reports_second_quarter'] = 'Secondo trimestre';

$lang['reports_start_date'] = 'Dal (aaaa-mm-gg)';
...
$lang['utilities_automatic_version_check'] = 'Controlla automaticamente la presenza di nuove versioni';

$lang['utilities_phpinfo'] = 'Informazioni PHP';

$lang['utilities_phpinfo_not_available'] = 'Questa funzione non &egrave disponibile nella demo.';

$lang['utilities_new_version_available'] = "Una nuova versione di BambooInvoice &egrave; disponibile. "; // space after period

$lang['utilities_up_to_date'] = "Stai usando la versione pi&ugrave; recente di BambooInvoice.";

$lang['utilities_connection_failed'] = "Impossibile stabilire una connessione a http://bambooinvoice.net.";

$lang['utilities_version_check'] = "Controlla la presenza di una nuova versione";
...
$lang['menu_did_you_know_quotes'] = array(
					...
					"BambooINVOICE ha il forum di aiuto su forums.bambooinvoice.net, per richiedere funzionalit&agrave; e consigli.",
					...
					"Il file di aiuto viene modificato quotidianamente.  Visita bambooinvoice.net per scaricare l'ultima versione!",
