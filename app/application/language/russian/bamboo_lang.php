...
$lang['utilities_connection_failed'] = "Невозможно установить соединение с http://bambooinvoice.net .";
...
$lang['menu_did_you_know_quotes'] = array(
					"У BambooINVOICE есть форум по адресу forums.bambooinvoice.net Обращайтесь с пожеланиями, за поддержкой, да и просто говорить.",
					"BambooINVOICE распространяется по лицензии GPL.",
					"Настройки всегда можно изменить в меню «Настройки». Логично не правда ли.",
					"Файл помощи устаревает с каждым дне. Добро пожаловать на bambooinvoice.net за последней версией!",
