...
class Clients extends MY_Controller
{
    ...
    function index()
    {
        ...
        if ($this->session->flashdata('clientEdit') != NULL) {
    ...
    function newclient()
    {
        ...
        if ($this->input->post('newClient') != NULL) {
            $this->session->set_flashdata('clientName', $this->input->post('newClient'));
        } elseif ($this->input->post('client_id') != NULL) {
    ...
    function _validation()
    {
        ...
        $rules['invoice_note_default'] = 'trim|max_length[255]';
        $rules['currency_type'] = 'trim|max_length[20]';
        $rules['currency_symbol'] = 'trim|max_length[9]';
        $rules['days_payment_due'] = 'trim|numeric|max_length[4]';
        ...
        $fields['invoice_note_default'] = $this->lang->line('invoice_note');
        $fields['currency_type'] = $this->lang->line('settings_currency_type');
        $fields['currency_symbol'] = $this->lang->line('settings_currency_symbol');
        $fields['days_payment_due'] = $this->lang->line('days_payment_due');
